    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.prisma.item.findMany({
                        where: {
                            name: {
                                contains: nameHas,
                            },
...
itemsRouter.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, item;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = +req.params.id;
                return [4 /*yield*/, prisma_1.prisma.item.findUnique({
                        where: {
                            id: id,
                        },
                    })];
...
itemsRouter.delete("/:id", auth_utils_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deleted;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
itemsRouter.post("/", auth_utils_1.authMiddleware, (0, zod_express_middleware_1.validateRequest)({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma_1.prisma.item.create({
...
itemsRouter.patch("/:id", auth_utils_1.authMiddleware, (0, zod_express_middleware_1.validateRequest)({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma_1.prisma.item.update({
                        where: {
                            id: id,
                        },
                        data: body,
